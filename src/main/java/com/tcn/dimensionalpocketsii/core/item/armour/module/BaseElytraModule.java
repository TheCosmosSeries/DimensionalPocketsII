...
public enum BaseElytraModule {
	...
	ENDER_CHEST(5, "screen_ender_chest", "dimensionalpocketsii.armour_module.ender_chest", ComponentColour.DARK_CYAN, ModBusManager.ARMOUR_MODULE_ENDER_CHEST, null);
