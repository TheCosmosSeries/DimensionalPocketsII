...
public enum EnumElytraSetting {
	...
	public static final StreamCodec<ByteBuf, EnumElytraSetting> STREAM_CODEC = new StreamCodec<ByteBuf, EnumElytraSetting>() {
		@Override
	...
	EnumElytraSetting(int indexIn, String nameIn, String localizedNameIn, String displayNameIn, String trueValueIn, String falseValueIn, ComponentColour displayColourIn) {
		this.index = indexIn;
		this.name = nameIn;
	...
	public MutableComponent getValueComp(boolean value) {
		return ComponentHelper.style(value ? ComponentColour.GREEN : ComponentColour.RED, "bold", value ? this.trueValue : this.falseValue);
	}
