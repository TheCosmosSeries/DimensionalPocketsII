...
import com.tcn.cosmoslibrary.energy.item.CosmosEnergyPickaxeItem;
...
public class DimensionalPickaxe extends CosmosEnergyPickaxeItem {
	
	public boolean enhanced;

	public DimensionalPickaxe(Tier itemTier, boolean enhanced, Properties builderIn, CosmosEnergyItem.Properties energyProperties) {
