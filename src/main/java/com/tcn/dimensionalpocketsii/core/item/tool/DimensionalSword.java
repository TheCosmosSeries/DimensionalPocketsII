...
import com.tcn.cosmoslibrary.energy.item.CosmosEnergySwordItem;
...
public class DimensionalSword extends CosmosEnergySwordItem {
	
	public boolean enhanced;

	public DimensionalSword(Tier itemTier, boolean enhanced, Properties builderIn, CosmosEnergyItem.Properties energyProperties) {
