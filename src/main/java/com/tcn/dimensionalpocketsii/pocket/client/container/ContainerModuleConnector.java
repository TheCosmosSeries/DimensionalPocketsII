...
public class ContainerModuleConnector extends CosmosContainerMenuBlockEntity {
	...
	public static ContainerModuleConnector createContainerClientSide(int windowID, Inventory playerInventory, FriendlyByteBuf extraData) {
		...
		return new ContainerModuleConnector(windowID, playerInventory, new SimpleContainer(ModReferences.CONSTANT.POCKET_HELD_ITEMS_SIZE_WITH), new SimpleContainer(ModReferences.CONSTANT.POCKET_HELD_ITEMS_SIZE_WITH + 2), pos);
	}
