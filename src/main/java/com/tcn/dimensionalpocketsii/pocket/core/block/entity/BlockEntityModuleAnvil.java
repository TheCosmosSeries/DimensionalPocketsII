...
public class BlockEntityModuleAnvil extends BlockEntity implements IBlockInteract, MenuProvider, IBEUIMode, IBEUILockable {
	...
	public BlockEntityModuleAnvil(BlockPos posIn, BlockState stateIn) {
		super(PocketsRegistrationManager.BLOCK_ENTITY_TYPE_ANVIL.get(), posIn, stateIn);
	}
				...
				if(pocketIn.exists()) {
					if (CosmosUtil.holdingWrench(playerIn)) {
						if (pocketIn.checkIfOwner(playerIn)) {
							ItemStack stack = new ItemStack(PocketsRegistrationManager.MODULE_ANVIL.get());
